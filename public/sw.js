...
self.addEventListener("push", (event) => {
  ...
  const options = {
    ...
    // Поле badge навмисно не задане. Android малює його як одноколірний
    // силует, і кольоровий логотип перетворюється на білу пляму. Без
    // цього поля система бере значок самого застосунку.
    vibrate: [120, 60, 120],
