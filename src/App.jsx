...
import {
  ...
  Waves, Building2, Camera, Settings, Pencil, Trash2, TreePine, MountainSnow, Landmark, Bike, ClipboardCheck, Loader2, Play, Lock, Info as InfoIcon
} from "lucide-react";
      ...
      <div style={{ padding: "18px 16px 0", marginTop: -12, background: C.page, borderRadius: "20px 20px 0 0" }}>
        ...
        <div style={card}>
          ...
          <Field label="Стан підготовки">
            <button onClick={() => set({ draft: !t.draft })} style={{
              display: "flex", alignItems: "center", gap: 10, width: "100%", textAlign: "left", fontFamily: "inherit",
              border: `1.5px solid ${t.draft ? C.rasp : C.green}`, background: t.draft ? "#fbeae6" : C.greenSoft,
              borderRadius: 12, padding: "12px 14px", cursor: "pointer",
            }}>
              <Lock size={16} style={{ color: t.draft ? C.rasp : C.greenDark, flexShrink: 0, opacity: t.draft ? 1 : 0.35 }} />
              <span style={{ flex: 1, minWidth: 0 }}>
                <span style={{ display: "block", fontSize: 13.5, fontWeight: 700, color: t.draft ? C.rasp : C.greenDark }}>
                  {t.draft ? "У розробці — глядачі бачать лише заглушку" : "Готова — глядачі бачать усе"}
                </span>
                <span style={{ display: "block", fontSize: 11.5, color: C.muted, marginTop: 2 }}>
                  {t.draft ? "Натисни, щоб опублікувати" : "Натисни, щоб сховати"}
                </span>
              </span>
            </button>
          </Field>
