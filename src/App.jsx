// ═══ Tropa Club · App.jsx · ВЕРСІЯ v125 ═══
...
//  • Водоспад — уступ і ХВИЛЯСТІ потоки: прямі лінії під уступом
//    читались як ніжки столу, хвилясті — як вода, що падає.
//  • Ріка — русло, що звивається й розширюється донизу, до глядача.
//  • Долина — плавні пагорби з сонцем між ними. Саме плавні лінії
//    замість гострих вершин і відрізняють її від гір.
// Ущелину й водоспад розведено навмисно: якби обидві були «двома
// скелями з водою між ними», вони знову стали б однаковими.
const PLACE_GLYPHS = {
  gorge: (
    <>
  ...
  waterfall: (
    <>
      <path d="M2 5.5 5 3.5l3.5 1 3.5-1.2h1.5" />
      <path d="M11 8c.6 2-.6 3.5 0 5.5s.6 3-.2 4" />
      <path d="M14 7c.7 2.2-.7 4 0 6.2s.7 3.3-.1 4.3" />
      <path d="M17 8.5c.5 1.8-.5 3 0 4.8s.4 2.4-.2 3.2" />
      <path d="M8 21c1-.8 2-.8 3 0s2 .8 3 0 2-.8 3 0 2 .8 3 0" />
    </>
  ),
  river: (
    <>
      <path d="M9 2c-.5 3 2.5 4.5 1 8S4 15 3 22" />
      <path d="M13 2c-.5 3 3.5 4.5 2.5 8.5S10 16 11 22" />
      <path d="M6.8 17.5c.6-.5 1.2-.5 1.8 0" />
    </>
  ),
  valley: (
    <>
